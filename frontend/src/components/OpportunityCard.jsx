      ...
      <div className="p-4 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {fresh && <span className="text-[10px] font-bold tracking-widest bg-[#0B1F3A] text-white px-2 py-0.5 rounded-full">NEW</span>}
          ...
          <p className="text-xs text-slate-400">{opp.category} · {formatDate(opp.createdAt)}</p>
        </div>
