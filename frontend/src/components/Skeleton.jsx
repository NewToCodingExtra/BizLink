  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 gap-3" role="status" aria-label={label}>
      <span className="relative flex w-11 h-11">
        <span className="absolute inline-flex h-full w-full rounded-full bg-[#2563EB]/20 animate-ping" />
        <span className="relative inline-flex w-11 h-11 rounded-full bg-[#0B1F3A] text-white items-center justify-center text-sm font-extrabold">B</span>
      </span>
...
export function OpportunityCardSkeleton() {
  return (
    <article className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden animate-pulse" aria-hidden="true">
      ...
      <div className="w-full h-[280px] bg-slate-100" />
      <div className="p-4 space-y-3">
        ...
        <div className="flex gap-2 pt-1">
          ...
          <div className="h-7 w-20 rounded-full bg-slate-100 ml-auto" />
...
export function StoriesBarSkeleton() {
  return (
    <div className="bg-white border border-slate-100 rounded-xl shadow-sm p-4 mb-4 max-w-2xl mx-auto animate-pulse" aria-hidden="true">
      <div className="h-3 w-44 rounded bg-slate-200" />
      <div className="mt-3 flex gap-4">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="shrink-0 text-center">
            <div className="w-[68px] h-[68px] rounded-full bg-slate-200" />
            <div className="mt-1.5 mx-auto h-2.5 w-12 rounded bg-slate-100" />
          </div>
        ))}
      </div>
    </div>
...
export function ReelSkeleton() {
  return (
    <div className="snap-start relative h-[100dvh] w-full bg-black flex items-center justify-center overflow-hidden animate-pulse" aria-hidden="true">
      <div className="h-full w-full max-w-md mx-auto bg-white/10" />
...
export function ProfileHeaderSkeleton() {
  return (
    <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 flex gap-4 animate-pulse" aria-hidden="true">
      ...
      <div className="mt-4 bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="p-6 space-y-3">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <div className="h-9 w-24 rounded-lg bg-slate-100 ml-auto" />
          </div>
        </div>
      </div>
    </div>
...
export function ListCardSkeleton({ rows = 4 }) {
  return (
    <div className="bg-white rounded-xl border border-slate-100 shadow-sm divide-y divide-slate-100 overflow-hidden animate-pulse" aria-hidden="true">
