export default function NotificationBell({ notifications = [], onToggle }) {
  ...
  return (
    <button onClick={onToggle} className="relative w-9 h-9 grid place-items-center rounded-full bg-surface/10 hover:bg-surface/15 text-white transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-blue-300">
